...
define(function () {
  ...
  function bookLibraryBase(id, configs) {
    ...
    var BookView = CORE.main.view.Main.View.extend({
      ...
      render:function () {
        console.log('CORE: bookLibraryBase: BookView render() called');
      ...
      deleteBook:function () {
        console.log('CORE: bookLibraryBase: BookView deleteBook() called');
        //Delete model
        this.model.destroy();
        //Delete view
        this.remove();
    ...
    var LibraryView = CORE.main.view.Main.View.extend({
      ...
      initialize:function(){
        console.log('CORE: bookLibraryBase: LibraryView initialize() called');
      ...
      addBook: function(e){
        console.log('CORE: bookLibraryBase: LibraryView addBook(e) called');
        ...
        //Empty the form fields by resetting the form
        $("#addBook")[0].reset();
      },
      removeBook: function(removedBook){
        console.log('CORE: bookLibraryBase: LibraryView removeBook(removedBook) called');
      ...
      renderBook:function(item){
        console.log('CORE: bookLibraryBase: LibraryView renderBook(item) called');
