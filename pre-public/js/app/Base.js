...
define(function () {
    ...
    function mainBase(id, require) {
		...
		var Model = this.Model = function(attributes, options) {
		...
		var Collection = this.Collection = function(models, options) {
			options || (options = {});
		...
		var View = this.View = function(options) {
		...
		_.extend(View.prototype, Events, {
			...
			setElement: function(element, delegate) {
			  ...
			  this.$el = element instanceof this.$ ? element : this.$(element);
			  this.el = this.$el[0];
		...
		var History = this.History = function() {
			this.handlers = [];
		...
		_.extend(History.prototype, Events, {
			...
			start: function(options) {
			  ...
			  if (this._hasPushState) {
				this.$(window).on('popstate', this.checkUrl);
			...
			stop: function() {
			  this.$(window).off('popstate', this.checkUrl).off('hashchange', this.checkUrl);
