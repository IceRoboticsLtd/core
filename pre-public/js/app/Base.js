/*
 * MainBase (contains all Backbone functionality)
 */
define(function () {
    ...
    function mainBase(id, require) {
		...
		var Events = Main.Events = {
			...
			on: function(name, callback, context) {
				console.log('CORE: mainBase Events on(name, callback, context) called');
			...
			once: function(name, callback, context) {
				console.log('CORE: mainBase Events once(name, callback, context) called');
			...
			off: function(name, callback, context) {
				console.log('CORE: mainBase Events off(name, callback, context) called');
			...
			trigger: function(name) {
				console.log('CORE: mainBase Events trigger(name) called');
			...
			stopListening: function(obj, name, callback) {
				console.log('CORE: mainBase Events stopListening(obj, name, context) called');
		...
		var eventsApi = function(obj, action, name, rest) {
			console.log('CORE: mainBase eventsApi(obj, action, name, rest) called');
			if (!name) return true;
			// Handle event maps.
		...
		var triggerEvents = function(events, args) {
			console.log('CORE: mainBase Events triggerEvents(events, args) called');
		...
		var Model = Main.Model = function(attributes, options) {
			console.log('CORE: mainBase Model(attributes, options) called');
			console.log('CORE: mainBase Model(attributes, options) attributes = ');
			console.log(attributes);
			console.log('CORE: mainBase Model(attributes, options) options = ');
			console.log(options);
		...
		_.extend(Model.prototype, Events, {
			...
			sync: function() {
				return Main.sync.apply(this, arguments);
			},
		...
		var Collection = Main.Collection = function(models, options) {
			console.log('CORE: mainBase Collection(models, options) called');
			options || (options = {});
		...
		var View = Main.View = function(options) {
			console.log('CORE: mainBase View(options) called');
			console.log('CORE: mainBase View(options) options = ');
			console.log(options);
		...
		Main.sync = function(method, model, options) {
			console.log('CORE: mainBase sync(method, model, options) called');
			console.log('CORE: mainBase sync(method, model, options) method = ');
			console.log(method);
			console.log('CORE: mainBase sync(method, model, options) model = ');
			console.log(model);	
			console.log('CORE: mainBase sync(method, model, options) options = ');
			console.log(options);
			var type = methodMap[method];
			// Default options, unless specified.
			_.defaults(options || (options = {}), {
				emulateHTTP: Main.emulateHTTP,
				emulateJSON: Main.emulateJSON
			});
			...
			var xhr = options.xhr = Main.ajax(_.extend(params, options));
		...
		Main.ajax = function() {
			console.log('CORE: mainBase ajax() called');
			return Main.$.ajax.apply(Main.$, arguments);
		};		
        // Adopted from Backbone		
		// Backbone.Router
		// ---------------
		...
		var Router = Main.Router = function(options) {
			console.log('CORE: mainBase Router(options) called');		
			console.log('CORE: mainBase Router(options) options = ');
			console.log(options);
			options || (options = {});
		...
		var History = Main.History = function() {
			console.log('CORE: mainBase History() called');
			this.handlers = [];
        ...
        var extend = function(protoProps, staticProps) {
            console.log('CORE: mainBase extend(protoProps, staticProps) called');
            console.log('CORE: mainBase extend(protoProps, staticProps): protoProps =');
            console.log(protoProps);
            console.log('CORE: mainBase extend(protoProps, staticProps): staticProps =');
        ...
        var urlError = function() {
            console.log('CORE: mainBase urlError() called');            
